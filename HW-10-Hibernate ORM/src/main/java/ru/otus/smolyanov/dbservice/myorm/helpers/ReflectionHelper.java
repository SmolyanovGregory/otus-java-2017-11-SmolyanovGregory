...
public class ReflectionHelper {
  ...
  public static void setSuperClassFieldValue(Object object, String name, Object value) {
    Field field = null;
    boolean isAccessible = true;
    try {
  ...
  public static Object geSuperClasstFieldValue(Object object, String name) {
    Field field = null;
    boolean isAccessible = true;
    try {
      field = object.getClass().getSuperclass().getDeclaredField(name);
